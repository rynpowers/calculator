...
export const plusMinusHelper = auxiliaryFn(n => n * -1);
export const percentHelper = auxiliaryFn(n => n / 100);

export const numberHelper = (state, string, calculator, e) => {
  let prevListener = state.getState('listener');
...
export const operatorHelper = (state, string, calculator, e) => {
  let prevListener = state.getState('listener');
...
export const executeHelper = (state, string, calculator) => {
  let prevListener = state.getState('listener');
